...
from portfolio.models import Crate, Challenge, Attempt, ReferenceTrack, seed_database
...
class DatabaseMergeTestCase(unittest.TestCase):
    ...
    def test_database_merge_script(self):
        ...
        source_cursor.execute("INSERT INTO crates VALUES (10, 'Sync Test Crate', 'Sync Crate Desc', 90, 100, 'house', 'Easy')")
        source_cursor.execute("INSERT INTO attempts VALUES (99, 1, NULL, 120.0, 120.0, 0.0, 0.0, 100, 'Tempo Wizard', NULL, 'test-uuid-999', 'Sync Test Crate', 1.0, NULL, 0, NULL, NULL, '2026-06-14T12:00:00')")
        ...
        target_cursor.execute(f"INSERT OR IGNORE INTO main.attempts ({cols_str}) SELECT {cols_str} FROM cmi.attempts")
        target_conn.commit()
